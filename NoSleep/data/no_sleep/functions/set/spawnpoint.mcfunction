#> no_sleep:set/spawnpoint
# スポーン地点を更新したかのチェック
### Copyright © 2022 赤石愛
### This software is released under the MIT License, see LICENSE.

### 使ったのはコマンドだよ
data modify storage no_sleep: type set value "command"
data modify storage no_sleep: force set value true
...
execute if data storage no_sleep: {_:true} run function no_sleep:save

### トリガーを解除
advancement revoke @s only no_sleep:set/spawnpoint
