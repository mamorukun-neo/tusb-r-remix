...
execute if score @s ShowSkill matches 6320 run data modify storage tusb_remake: skill_name set value "ファイナルカタストロフィ"
execute if score @s ShowSkill matches 6330 run data modify storage tusb_remake: skill_name set value "インバイトアビス"