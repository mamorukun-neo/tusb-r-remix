...
data modify storage tusb_remake: _.27 set value {name:["魔弾一閃"],level:[75],cost:150,description:[["命中すると広範囲に大ダメージを与える特殊な矢を放つ。"]],condition:"利き手で弓を構え矢を放つ",range:[45]}
data modify storage tusb_remake: _.28 set value {name:["エースインザホール"],level:[100],cost:300,description:[["矢の周囲にいる味方の体力を持続回復し、敵にダメージを与える。着弾時、広範囲の味方の体力を回復し、敵にダメージを与える"]],condition:"利き手で弓を構え矢を放つ",range:[8]}
