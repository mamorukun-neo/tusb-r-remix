...
data modify storage tusb_remake: _.26 set value {name:["マジカルドレイン"],level:[75],cost:150,description:[["付近の敵から体力と魔力を吸い取る。"]],condition:"ニンジン付きの棒を持って右クリック"}
data modify storage tusb_remake: _.27 set value {name:["ライトニングシャワー"],level:[100],cost:300,description:[["周囲の敵に一定時間雷を落とす。雷の近くにいる味方のデバフを解除し体力と魔力を回復する。"]],duration:[20],condition:"ニンジン付きの棒を持って右クリック",range:[10]}
