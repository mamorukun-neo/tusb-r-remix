...
data modify storage tusb_remake: _.26 set value {name:["ウォープレリュード"],level:[75],cost:50,description:[["HPを大幅回復しデバフを解除する。"]],condition:"被ダメージ"}
data modify storage tusb_remake: _.27 set value {name:["夢想真説"],level:[100],cost:300,description:[["周囲の敵に1000ダメージ。"]],condition:"剣で攻撃",range:[30]}
