...
data modify storage tusb_remake: _.24 set value {name:["天気雨"],level:[51],cost:150,description:[["雨の降る場所の周囲にいる味方の体力と魔力を持続的に回復する。"]],condition:"ニンジン付きの棒を持って右クリック",range:[12]}
data modify storage tusb_remake: _.25 set value {name:["ホーリーシャワー"],level:[100],cost:300,description:[["自身の周囲に聖なる力の雨を降らす。"]],condition:"ニンジン付きの棒を持って右クリック",range:[60]}
