...
execute as @a at @s if entity @s[tag=tatama] if score @s kyoumei matches 1.. run kill @e[type=item,nbt={Item:{tag:{ItemUID:6}}},limit=1,sort=nearest]
...
execute as @a at @s if entity @s[tag=tmune] if score @s kyoumei matches 1.. run kill @e[type=item,nbt={Item:{tag:{ItemUID:5}}},limit=1,sort=nearest]
...
execute as @a at @s if entity @s[tag=tasi] if score @s kyoumei matches 1.. run kill @e[type=item,nbt={Item:{tag:{ItemUID:4}}},limit=1,sort=nearest]
...
execute as @a at @s if entity @s[tag=tkutu] if score @s kyoumei matches 1.. run kill @e[type=item,nbt={Item:{tag:{ItemUID:1}}},limit=1,sort=nearest]
...
execute as @a at @s if entity @s[tag=patama] if score @s kyoumei matches 1.. run kill @e[type=item,nbt={Item:{tag:{ItemUID:1}}},limit=1,sort=nearest]
...
execute as @a at @s if entity @s[tag=pmune] if score @s kyoumei matches 1.. run kill @e[type=item,nbt={Item:{tag:{ItemUID:1}}},limit=1,sort=nearest]
...
execute as @a at @s if entity @s[tag=pasi] if score @s kyoumei matches 1.. run kill @e[type=item,nbt={Item:{tag:{ItemUID:1}}},limit=1,sort=nearest]
...
execute as @a at @s if entity @s[tag=pkutu] if score @s kyoumei matches 1.. run kill @e[type=item,nbt={Item:{tag:{ItemUID:1}}},limit=1,sort=nearest]
...
execute as @a at @s if entity @s[tag=sken] if score @s kyoumei matches 1.. run kill @e[type=item,nbt={Item:{tag:{ItemUID:7}}},limit=1,sort=nearest]
...
execute as @a at @s if entity @s[tag=syumi] if score @s kyoumei matches 1.. run kill @e[type=item,nbt={Item:{tag:{ItemUID:8}}},limit=1,sort=nearest]
...
execute as @a at @s if entity @s[tag=dtue] if score @s kyoumei matches 1.. run kill @e[type=item,nbt={Item:{tag:{ItemUID:2}}},limit=1,sort=nearest]
...
execute as @a at @s if entity @s[tag=humetu] if score @s kyoumei matches 1.. run kill @e[type=item,nbt={Item:{tag:{ItemUID:13}}},limit=1,sort=nearest]
...
execute as @a at @s if entity @s[tag=nizi] if score @s kyoumei matches 1.. run kill @e[type=item,nbt={Item:{tag:{ItemUID:14}}},limit=1,sort=nearest]
...
execute as @a at @s if entity @s[tag=konton] if score @s kyoumei matches 1.. run kill @e[type=item,nbt={Item:{tag:{ItemUID:3}}},limit=1,sort=nearest]
...
execute as @a at @s if entity @s[tag=tuma] if score @s kyoumei matches 1.. run kill @e[type=item,nbt={Item:{tag:{ItemUID:16}}},limit=1,sort=nearest]
...
execute as @a at @s if entity @s[tag=bsaiuzu] if score @s kyoumei matches 1.. run kill @e[type=item,nbt={Item:{tag:{ItemUID:15}}},limit=1,sort=nearest]
...
execute as @a at @s if entity @s[tag=tate] if score @s kyoumei matches 1.. run kill @e[type=item,nbt={Item:{tag:{ItemUID:17}}},limit=1,sort=nearest]
