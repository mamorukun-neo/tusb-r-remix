...
execute as @a[tag=tatama1,limit=1,sort=nearest] at @s run tag @s remove tatama1
...
execute as @a[tag=patama1,limit=1,sort=nearest] at @s run tag @s remove patama1
...
tag @a[tag=dtue1,sort=nearest,limit=1] remove dtue1
...
tag @a[tag=konton1,sort=nearest,limit=1] remove konton1
