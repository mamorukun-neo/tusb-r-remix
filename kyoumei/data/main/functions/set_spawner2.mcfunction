...
data modify entity @e[tag=SetSpawner,limit=1,sort=nearest] SpawnData set from storage tusb_remake: spawn_data_2

data modify entity @e[tag=SetSpawner,limit=1,sort=nearest] SpawnPotentials set from storage tusb_remake: spawn_potentials_2
